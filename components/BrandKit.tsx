...
export const BrandKit: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-8 md:mt-24 mb-20 px-4 relative">
      
      {/* CINEMA MODE OVERLAY (MOCKUP FULLSCREEN) */}
      {cinemaMode && (
         <div className="fixed inset-0 z-[100] bg-black flex items-center justify-center p-4 animate-fade-in overflow-hidden">
            <button 
            ...
            {cinemaMode === 'neon' && (
              <div className="relative w-full h-full max-w-6xl max-h-[80vh] flex items-center justify-center">
                 ...
                 <div className="relative transform scale-90 md:scale-150 filter drop-shadow-[0_0_25px_rgba(0,242,96,0.9)] max-w-[90vw] overflow-hidden">
                    <BrandLogo 
                       key={downloadSize}
                       size="xl" 
            ...
            {cinemaMode === 'card' && (
               <div className="relative w-full h-full flex items-center justify-center bg-[#e0e0e0]">
                  ...
                  <div className="bg-white w-[90vw] md:w-[600px] h-[55vw] md:h-[350px] shadow-2xl flex items-center justify-center transform scale-100" style={{ borderRadius: '20px' }}>
            ...
            {cinemaMode === 'glass' && (
               <div className="relative w-full h-full flex items-center justify-center bg-gray-900">
                  ...
                  <div className="w-full max-w-[90vw] md:max-w-4xl h-40 md:h-64 bg-white/5 backdrop-blur-xl border-y border-white/10 flex items-center justify-center transform scale-100">
      ...
      <div className="bg-[#1a1638] border border-brand-accent/30 rounded-3xl p-6 md:p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-brand font-bold text-white mb-2 uppercase flex items-center gap-3">
            ...
            <div className="space-y-5 bg-white/5 p-5 rounded-2xl border border-white/10">
                 ...
                 <div>
                   ...
                   <div className="flex gap-2 items-center">
                        <input type="text" value={brandName1} onChange={(e) => setBrandName1(e.target.value.toUpperCase())} className="flex-1 bg-black/40 border border-white/10 rounded-lg px-2 py-2 text-sm font-bold text-white text-center focus:border-brand-accent outline-none min-w-0" placeholder="SEK"/>
                        ...
                        <input type="text" value={brandName2} onChange={(e) => setBrandName2(e.target.value.toUpperCase())} className="flex-1 bg-black/40 border border-white/10 rounded-lg px-2 py-2 text-sm font-bold text-white text-center focus:border-brand-accent outline-none min-w-0" placeholder="COMIX"/>
                   </div>
                          ...
                          <div className="max-h-60 overflow-y-auto custom-scrollbar space-y-3">
                              {Object.keys(categorizedIcons).map(cat => (
                                <div key={cat}>
                                    ...
                                    {/* RESPONSIVE GRID: 4 columns on mobile, 5 on desktop */}
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="bg-gradient-to-br from-[#0f0c29] to-[#1a1638] p-4 rounded-xl border border-brand-accent/20">
               ...
               <div className="space-y-6">
                  ...
                  <div 
                    onClick={() => setCinemaMode('neon')} 
                    className="relative h-40 rounded-lg overflow-hidden border border-white/5 shadow-2xl group cursor-pointer hover:border-brand-accent/50 transition-colors"
                  >
                     ...
                     <div className="absolute bottom-2 left-2 text-[10px] font-bold bg-black/50 px-2 py-1 rounded text-white backdrop-blur-sm"><Zap size={10} className="inline mr-1"/> INSEGNA NEON (Clicca)</div>
                  </div>

                  {/* SCENARIO 2: BUSINESS CARD */}
                  <div 
                    onClick={() => setCinemaMode('card')} 
                    className="relative h-40 rounded-lg overflow-hidden border border-white/5 bg-[#e0e0e0] group cursor-pointer hover:border-brand-accent/50 transition-colors"
                  >
                     {/* Paper Texture */}
                     ...
                     <div className="absolute bottom-2 left-2 text-[10px] font-bold bg-white/80 text-black px-2 py-1 rounded backdrop-blur-sm"><CreditCard size={10} className="inline mr-1"/> BUSINESS CARD (Clicca)</div>
                  </div>

                  {/* SCENARIO 3: GLASS TOTEM */}
                  <div 
                    onClick={() => setCinemaMode('glass')} 
                    className="relative h-40 rounded-lg overflow-hidden border border-white/5 bg-gray-900 group cursor-pointer hover:border-brand-accent/50 transition-colors"
                  >
                     {/* Abstract Background */}
                     ...
                     <div className="absolute bottom-2 left-2 text-[10px] font-bold bg-black/50 px-2 py-1 rounded text-white backdrop-blur-sm"><Monitor size={10} className="inline mr-1"/> TOTEM VETRO (Clicca)</div>
                  </div>
